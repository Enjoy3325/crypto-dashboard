...
export default function ChartContainer() {
  return (
    <motion.div 
      ...
      whileHover={{ scale: 1.01, boxShadow: "0 8px 64px 0 rgba(21,229,245,0.25)" }}
    >
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-2xl font-bold text-cyan-100 mb-1 tracking-wide">Market Analysis</h2>
          <p className="text-sm text-cyan-400/80">Real-time & Historical Data</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div className="px-3 py-1 bg-blue-500/20 rounded-full border border-cyan-400/20 shadow-md">
            <span className="text-xs text-cyan-300 font-medium">Auto-update</span>
          </div>
        </div>
      </div>
      <CryptoChart />
